...
/**
 * Created by trungdovan on 25/04/2017.
 */
public class CORSFilter implements Filter {
  ...
  public static final String DEFAULT_ACCESS_CONTROL_ALLOW_METHODS_VALUE = "POST, GET, OPTIONS, DELETE";
  ...
  private Map<String,String> initConfig(){
    ...
    result.put(ACCESS_CONTROL_ALLOW_METHODS_NAME,"accessControlAllowMethods");
